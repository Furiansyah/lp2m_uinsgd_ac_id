...
class Pusat_pengabdian_masyarakat extends CI_Controller {
...
$this->load->helper('url');
 ...
 if (isset($_POST['q'])) {
		...
		$this->load->view('main/header');
  		$this->load->view('profil',$data,$data1);
 ...
 if (isset($_POST['q'])) {
		...
		$this->load->view('main/header');
  		$this->load->view('chat',$data,$data1);
 		$this->load->view('main/footer');
    }
    ...
    public function kirim_chat()
    {
        ...
        mysql_query("insert into forum_diskusi (name,pesan) VALUES ('$name','$pesan')");
        redirect ("pusat_pengabdian_masyarakat/ambil_pesan");
    }
     
    public function ambil_pesan()
    {
        $tampil=mysql_query("select * from forum_diskusi order by waktu desc");
        while($r=mysql_fetch_array($tampil)){
        echo "<li><b>$r[name]</b> : $r[pesan] (<i>$r[waktu]</i>)</li>";
        }
   } 
