...
$this->load->helper('url');
 ...
 if (isset($_POST['q'])) {
		...
		// pagination limit
		$pagination['base_url'] ='home/index/page/';
		...
		$data['ringkasan'] = $this->berita->post_list_berita();
		
		$this->load->view('main/header',$data);
  		$this->load->view('main/home',$data,$data1);
 ...
 if (isset($_POST['q'])) {
		...
		// pagination limit
		$pagination['base_url'] ='home/hasil_cari/page/';
		$pagination['total_rows'] = $this->db->count_all_results();
		$pagination['full_tag_open'] = "<p><div class=\"pagination\" style='letter-spacing:2px;'>";
		$pagination['full_tag_close'] = "</div></p>";
		$pagination['cur_tag_open'] = "<span class=\"current\">";
