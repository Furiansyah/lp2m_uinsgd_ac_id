<div class="container">
	...
	<div class="nam-matis-top">
						...
						<h1 align="center"><font color="green" face="Georgia, Times New Roman, Times, serif">Formulir Pendaftaran Kuliah Kerja Mahasiswa</font></h1><br /><br />
            ...
            tinyMCE.init({
              ...
              relative_urls : false
				 ...
				 <?php foreach($jadwal->result_array() as $list) { ?>
	<form name="form1" method="post" action="<?php echo base_url() ?>kkm/daftar" class="myform">
	  <p>
	    <label for="judul">Nomer Induk Mahasiswa</label>
			    <input value="<?php echo $list['nim']; ?>" name="nim" type="text" id="nim" size="30">
      </p>
	  <p>
	    <label for="judul">Nama</label>
	    <input  value="<?php echo $list['nama']; ?>" name="nama" type="text" id="nama" size="30">
      </p>
	  <p>
	    <label for="jurusan">Program Studi</label>
		 <input  value="<?php echo $list['jurusan']; ?>" name="jurusan" type="text" id="jurusan"  size="30">
	   </p>
	     <p>
	    <label for="fakultas">Fakultas</label>
		  <input  value="<?php echo $list['fakultas']; ?>" name="fakultas" type="text" id="fakultas"  size="30">
	   </p>
