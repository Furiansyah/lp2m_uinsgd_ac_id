			...
			<ul class="menu">
			      ...
			      <ul>
				    <li><a href="<?php echo base_url(); ?>home/read/pusat-penelitian-dan-penerbitan-masyarakat">Pusat Penelitian dan Penerbitan</a>
			            ...
			            <li><a href="<?php echo base_url(); ?>home/read/pusat-pengabdian-masyarakat">Pusat Pengabdian Masyarakat</a>
			              <ul>
			                    <li><a href="<?php echo base_url(); ?>home/read/pusat-pengabdian-masyarakat">Profil</a></li>
								 <li><a href="#">Program</a></li>
			                    <li><a href="#">Unduh</a>
									<ul>
										<li><a href="#">Pedoman</a></li>
								 ...
								 <li><a href="#">PKM Dosen</a></li>
								  <li><a href="#">Kerjasama</a></li>
			              </ul>
			            </li>
			          
			          	<li><a href="<?php echo base_url(); ?>home/read/pusat-studi-gender-dan-anak">Pusat Studi Gender dan Anak</a>  
						 <ul>
			                    ...
			                    <li><a href="#">Unduh</a>
								  ...
								  <li><a href="#">Kegiatan</a>
									<ul>
										...
										<li><a href="#">Kegiatan dan Penelitian</a></li>
							...
							<li><a href="<?php echo base_url(); ?>halberita">BERITA</a></li>
