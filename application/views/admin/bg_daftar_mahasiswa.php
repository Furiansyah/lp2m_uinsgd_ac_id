...
<div id="container">
	<h1>Input Nilai - Sistem Informasi Pendaftaran KKM</h1>
	...
	<div id="body">
		...
		<td height=27>No.</td><td>NIM</td><td>Nama Mahasiswa</td><td>Jurusan</td><td>Status Persetujuan</td><td width=100>Masukkan Nilai</td>
		</tr>
		<?php
			$no=1;
