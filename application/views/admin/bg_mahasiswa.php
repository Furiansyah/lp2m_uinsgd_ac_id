...
<div id="container">
	<h1>Daftar Mahasiswa Sistem Informasi Manajemen Penelitian dan PPM</h1>
	...
	<?php
		echo '<a href="'.base_url().'tbl_daftar_kkm/create" rel="example_group" class="link" style="float:left;">Tambah Mahasiswa</a>';
	?>
	</td>
	</tr>
	...
	<?php
		...
		?>
			...
			<td align="center"><?php echo $d['id_kelompok']; ?></td>
			<td align="center" width="60">
			<?php
			echo '<a href="'.base_url().'tbl_daftar_kkm/update/'.$d['nim'].'" rel="example_group" class="link" style="float:left;">Edit</a>
				</td>
				<td align="center" width="60">
				<a href="'.base_url().'tbl_daftar_kkm/delete/'.$d['nim'].'"
